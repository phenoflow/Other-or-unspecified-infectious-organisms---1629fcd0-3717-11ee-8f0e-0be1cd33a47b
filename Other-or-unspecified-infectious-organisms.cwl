...
steps:
  ...
  other-or-unspecified-infectious-organisms-laryngitis---secondary:
    run: other-or-unspecified-infectious-organisms-laryngitis---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  other-or-unspecified-infectious-organisms-tonsillitis---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: other-or-unspecified-infectious-organisms-laryngitis---secondary/output
